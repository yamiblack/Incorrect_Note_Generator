...
<%@page import="java.util.ArrayList" import="jsp.util.DBConnection"
...
<link
	href="${pageContext.request.contextPath}/resources/custom/css/schedule.css"
	rel="stylesheet">
<script
	src='${pageContext.request.contextPath}/resources/custom/js/schedule.js'></script>

<link
	href='${pageContext.request.contextPath}/resources/css/calendar_main.css'
	rel='stylesheet' />
<script
	src='${pageContext.request.contextPath}/resources/js/calendar_main.js'></script>
